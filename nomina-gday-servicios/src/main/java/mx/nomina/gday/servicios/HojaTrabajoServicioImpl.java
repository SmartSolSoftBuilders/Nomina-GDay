        ...
        try{
        	...
        	fila.createCell(j+4).setCellValue("Total");
           	...
           	for (j=0; j<empleados.size();j++){
           		...
           		fila.createCell(10).setCellValue(empleados.get(j).getSexo());
           		fila.createCell(11).setCellValue(empleados.get(j).getPaisOrigen());           		
           		fila.createCell(12).setCellValue(empleados.get(j).getNacionalidad());
           		fila.createCell(13).setCellValue(empleados.get(j).getEstadoCivil());
           		fila.createCell(14).setCellValue(empleados.get(j).getCorreoElectronico());
           		fila.createCell(15).setCellValue(empleados.get(j).getFechaIngresoReal());
           		fila.createCell(16).setCellValue(empleados.get(j).isListaNegra());
           		fila.createCell(17).setCellValue(empleados.get(j).getCalle());
           		//------Test-          		
           		fila.createCell(18).setCellValue(empleados.get(j).getNumExterior());
           		fila.createCell(19).setCellValue(empleados.get(j).getNumInterior()); 
           		fila.createCell(20).setCellValue(empleados.get(j).getColonia());
           		fila.createCell(21).setCellValue(empleados.get(j).getCodigoPostal());
           		fila.createCell(22).setCellValue(empleados.get(j).getMunicipioDel());
           		fila.createCell(23).setCellValue(empleados.get(j).getEntFederativa());
           		fila.createCell(24).setCellValue(empleados.get(j).isDocIfe());
           		fila.createCell(25).setCellValue(empleados.get(j).isDocActNan());
           		fila.createCell(26).setCellValue(empleados.get(j).isDocCurp());
           		fila.createCell(27).setCellValue(empleados.get(j).isDocRfc());
           		fila.createCell(28).setCellValue(empleados.get(j).isDocComprobante());
           		fila.createCell(29).setCellValue(empleados.get(j).isDocCompEst());
           		fila.createCell(30).setCellValue(empleados.get(j).isDocCorreo());
           		fila.createCell(31).setCellValue(empleados.get(j).isDocPreafiliacion());
           		fila.createCell(32).setCellValue(empleados.get(j).getCuenta());
           		fila.createCell(33).setCellValue(empleados.get(j).getBanco());
           		fila.createCell(34).setCellValue(empleados.get(j).getTipoPago());
           		fila.createCell(35).setCellValue(empleados.get(j).getNoCredInfonavit());
           		fila.createCell(36).setCellValue(empleados.get(j).getDescInfonavitVsmg());
           		fila.createCell(37).setCellValue(empleados.get(j).getDesInfonavitPorc());
           		fila.createCell(38).setCellValue(empleados.get(j).getDescInfonavitImp());
           		fila.createCell(39).setCellValue(empleados.get(j).getDescFonacotPago());
           		fila.createCell(40).setCellValue(empleados.get(j).getDescFonacotNum());           		
