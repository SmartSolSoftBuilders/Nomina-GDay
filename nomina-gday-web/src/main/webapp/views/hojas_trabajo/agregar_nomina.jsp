...
<script type="text/javascript" language="javascript" src="../../static/js/app/hojas_trabajo/agregar_nomina.js"></script>
</head>
<body>
	<div class="container">
	<h1><font color=#0051a4 class="mayuscula">Agregar N&oacute;mina</font></h1>
