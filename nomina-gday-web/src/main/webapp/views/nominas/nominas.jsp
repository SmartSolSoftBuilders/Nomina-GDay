...
<html>
	...
	<body id="dt_example">
		...
		<!-- 			Modal para consultar Empleado por Nomina -->				
			<div class="row">
				<div id="divSeleccionNominaPorEmpleado" title="CONSULTA DE EMPLEADOS POR N&#211;MINA" style="display:none"  class="col-lg-6">
				<table  cellpadding="0" cellspacing="0" border="0" class="display" id="tablaEmpleados">
					<thead>			
						<tr class="odd gradeA">
							<th>ID</th>
							<th>CURP</th>					
				...
				<input type="button" class="btn btn-success" value="DESCARGAR NOMINA" onclick="ajax_download();"/>
				<br>
				<br>
				</div>
			</div>
