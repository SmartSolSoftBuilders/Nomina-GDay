	...
	<table>
		<tr>			
			...
			<table>
				<tr>	
					<td align="center">
						<input style="width:300px;" type="button" onclick="obtenerAcumulados();$('#botonSubmit').show();" class="form-control" value="Consultar Acumulados">
					</td>
					<td>
					</td>
				</tr>
...
<!-- /.container -->
	...
	<div id="divLoading" title="Por favor espere" style="display: none" class="col-lg-6">
		Por favor espere, se están obteniendo los acumulados de la nómina..........................<br>
	...
	<div id="divLoading2" title="Por favor espere" style="display: none" class="col-lg-6">
		Por favor espere, se está subiendo el archivo de acumulado para la nómina..........................<br>
		<center><img name="imgLoading2" id="imgLoading2" src="../../static/img/loading_bar2.gif"></img></center>
	</div>
