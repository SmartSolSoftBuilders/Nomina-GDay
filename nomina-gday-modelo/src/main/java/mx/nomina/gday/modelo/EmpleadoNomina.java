...
public class EmpleadoNomina {
			...
			public EmpleadoNomina(int idNomina, int idEmpleado, int idPuesto,
					int idDepartamento, int idArea, int idProceso,
					String fechaIngreso, String estatus, String tipoSalario,
					String fechaBaja, String loteMovImssAlta,
					String fechaVencimiento, double sueldoMensual,
