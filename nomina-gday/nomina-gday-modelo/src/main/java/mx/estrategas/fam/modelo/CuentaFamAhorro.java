...
public class CuentaFamAhorro extends BaseModelo {
	...
	private List<MontoDescuentoCuentaFam> montosDescuentoCuentaFam;
	
	public List<MontoDescuentoCuentaFam> getMontosDescuentoCuentaFam() {
		return montosDescuentoCuentaFam;
	}
	public void setMontosDescuentoCuentaFam(
			List<MontoDescuentoCuentaFam> montosDescuentoCuentaFam) {
		this.montosDescuentoCuentaFam = montosDescuentoCuentaFam;
	}
	...
	public CuentaFamAhorro(){
		
	}
	public CuentaFamAhorro(int idCuentaFamAhorro, double saldo,
			...
			Afiliado afiliado, List<MontoDescuentoCuentaFam> montosDescuentoCuentaFam) {
		super();
		this.idCuentaFamAhorro = idCuentaFamAhorro;
		this.saldo = saldo;
		this.fechaApertura = fechaApertura;
