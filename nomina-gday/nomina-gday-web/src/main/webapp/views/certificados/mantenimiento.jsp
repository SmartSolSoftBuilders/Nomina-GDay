...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript" src="../../static/js/app/certificados/mantenimiento.js"></script>
	...
	<body id="dt_example">
		<div id="container">
			<h1>
				Seleccione un certificado para corregir sus datos
			</h1>
			<div id="demo">
				<form id="formMantenimientoCertificados">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display" id="tablaCertificados">
					<thead>
						<tr>
							<th>Id</th>
							<th>N&uacute;mero</th>								
			...
			<br>
			<div align="center">
				<input type="button" value="Corregir datos" onclick="corregirDatosCertificado()"/>				
			</div>
			<br>
			<br>
