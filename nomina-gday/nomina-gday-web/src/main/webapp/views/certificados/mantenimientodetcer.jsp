...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript" src="../../static/js/app/certificados/mantenimientodetcer.js"></script>
	...
	<body id="dt_example">
		<div id="container">
			<h1>Seleccione un certificado para modificar su contenido</h1>		
			<div id="demo">
				<form id="formMantenimientoCertificados">
					<div style="text-align:right; padding-bottom:1em;">
						<!--button type="submit">Submit form</button-->
					</div>
					<table cellpadding="0" cellspacing="0" border="0" class="display" id="tablaCertificadosDet">
					<thead>			
						<tr>
							<th>Id</th>
							<th>N&uacute;mero</th>								
			...
			<br>		
			<div align="center">
				<input type="button" value="Corregir datos" onclick="corregirContenidoCertificado()"/>				
			</div>
			<br>
			<br>
</div>	
