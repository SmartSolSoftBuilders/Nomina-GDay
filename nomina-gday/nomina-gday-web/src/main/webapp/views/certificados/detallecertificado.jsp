...
-->
	...
	<script type="text/javascript" language="javascript" src="../../static/js/app/certificados/detalle.js"></script>
	...
	jQuery(document).ready(function(){
		$( "#fechavigencia" ).datepicker({ dateFormat: "yy-mm-dd" });		
...
<legend>
<div id="divLabelCertificadoactual">Cambios a Aplicar </div>
<table border=0>
		<tr>
			<td>		            
	        ...
	        <div align="center">
                  ...
                  <table border=0>
                    <tr>
                      <td><fieldset>
                        <legend></legend>
                        <legend>N&uacute;mero</legend>
                        <div id="numerocertificadoactual"> </div>
                      ...
                      <td><fieldset>
                        <legend></legend>
                        <legend>Suma Asegurada</legend>
							<div id="sumaaseguradaactual"></div>
                        <legend>Fecha Vigencia</legend>
							<div id="fechavigenciaactual"></div>
                      </fieldset></td>
                    </tr>
                  </table>
                </form>
              ...
              <div align="center">
                <input name="button2" type="button" onClick="aprobarCambiosCert()" value="Aprobar" />
                <input name="button2" type="button" onClick="denegarCambiosCert()" value="Denegar" />
              </div>
              </div>	 
