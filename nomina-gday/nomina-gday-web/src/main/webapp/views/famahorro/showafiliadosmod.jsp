...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript" src="../../static/js/app/famahorro/showafiliadosmod.js"></script>
	...
	<body id="dt_example">
		<div title="Selección de Cuentas" id="dialogcuentas" style="display:none">
			Seleccione la cuenta FAM Ahorro a Modificar:
			<select name="cuentaFamAhorroSel" id="cuentaFamAhorroSel" >								
			</select>
			<center><input type="button" value="Aceptar" onclick="cambiaIdFamAhorro()"/></center>
		</div>
		<div id="container">
			<h1>Seleccione un Afiliado para modificar un contrato FAMAhorro</h1>
			<div id="demo">
			...
			<br>		
			<div align="center">
				<input type="button" value="Modificar Cuenta FAMAhorro" onclick="crearCuentaFamAhorro()"/>				
				<input type="button" value="Modificar Cuenta Inversión" onclick="crearCuentaInversion()"/>				
				<input type="button" value="Movimientos Cuentas FAMAhorro" onclick="verMovimientosFamAhorro()"/>
			</div>
			<br>
			<br>
