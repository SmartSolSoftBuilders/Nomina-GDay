<html>
 <head>  	
	...
	<title>Modificar Afiliado en FAMAhorro</title>
	...
	<script type="text/javascript" language="javascript" src="../../static/js/app/famahorro/modificacion.js"></script>	
...
<div align="left">
	<form id="formAltaAfiliado2"   name="formAltaAfiliado2" class="formular" style="width:1400px;" action="../../mvc/afiliado/guardar" method="post">
	<h1>Por favor modifique los datos del Afiliado registrado en FAMAhorro:</h1>
		<table border=0>
			<tr>
				<td>
					<fieldset> 
					...
					<table border=0 >
						<tr>
							<td>
							<legend>Saldo</legend>
							<label><input value="" class="validate[required] text-input" type="text" name="saldo" id="saldo" /></label>
				...
				<td>
					...
					<tr>								
						<td>
							...
							<legend>Monto de Descuento</legend>
							<label>	<div id="montoDescuentoDiv"></div> 
								<a href="#" onclick="showMontosDescuentosCuentaFamAhorro()">
									<img width="20" height="20" src="../../static/img/historial.jpg"/>
								</a>
							</label>
							<div id="divMontosDescuentos" style="display:none"><h4>Historial Montos Descuento</h4><div id="contentMovsDesc"></div></div>
							<legend>Porcentaje de Sueldo base de ahorro mensual:</legend>							
							<label>	
		...
		<table border=0>
			<tr>
				<td>
					...
					<table border=0 >
						<tr> 
							...
							<label><input value="" class="validate[required] text-input" type="text" name="apppersonaauto" id="apppersonaauto" /></label>
				...
				<input  type="hidden" name="idpersonaauto" id="idpersonaauto" />
				</td>
				<td>
					<fieldset> 
					...
					<table border=0 >
						<tr>
							...
							<td>	
								...
								<label><input value="" class="validate[required] text-input" type="text" name="porcentajeBenefCuentaFamAhorro1" id="porcentajeBenefCuentaFamAhorro1" size=4/></label>
								<input  type="hidden" name="idbenef1" id="idbenef1" />
						</table>
					</fieldset>
				</td>
				<td>
					...
					<table border=0 >
						<tr>
							...
							<td>
								...
								<input  type="hidden" name="idbenef2" id="idbenef2" />											
						</table>
					</fieldset>
				</td>																								
			</tr>
		</table>
		<center><input type="button" id="guardarContratoModFamAhorro" value="Guardar" onclick="guardarContrato()"/></center>		
	</form>	
</div>
</body>			
</html>