...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript" src="../../static/js/app/aprobaciones/aprobaciones.js"></script>
	</head>
<body id="dt_example">
	<div id="container"><h1>Aprobaci&oacute;n de Cambios de Afiliados</h1>
		</div>		
	<div id="demo">
