<html>
 <head>  	
	...
	<script type="text/javascript" language="javascript" src="../../static/js/app/afiliados/modifica.js"></script>	
	...
	<script>
		jQuery(document).ready(function(){
			...
			jQuery("#formModificaAfiliado").validationEngine();	
		});
...
<body id="dt_example">
<div id="container" >
	<h1>Por favor modifique los datos del Afiliado</h1>
</div>
<div align="center">
<form id="formModificaAfiliado"  name="formModificaAfiliado" class="formular" style="width:700px;" action="../../mvc/afiliado/guardar" method="post">
	<table border=0>
		<tr>
			<td>
				<fieldset> 
	...
	<table border=0>
		<tr>
			...
			<td align=CENTER>
				...
				<input id="botonguardar" name="botonguardar" class="button" type="button" value="Guardar Cambios" onclick="guardarAfiliado()"/><hr/>
