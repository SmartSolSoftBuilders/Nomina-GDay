...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript" src="../../static/js/app/catalogos/mant_municipios.js"></script>
	...
	<body id="dt_example">
		<div id="container">
			<h1>
				Seleccione un municipio para modificar sus datos
			</h1>		
			<div id="demo">
				<form id="formMantenimientoMunicipios">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display" id="tablaMunicipios">
					<thead>			
						<tr>
							<th>Id</th>						
							<th>Nombre</th>													
			...
			<div id="divMunicipios" style="display:none">
				Nombre:<input type="text" id="nombremunicipio" name="nombremunicipio"/>				
				<input type="hidden" id="idmunicipio" name="idmunicipio"/>
			</div>
			<br>
			<br>		
			<div align="center">
				<input type="button" value="Corregir datos" onclick="corregirDatosMunicipios()"/>				
			</div>
			<br>
			<br>
