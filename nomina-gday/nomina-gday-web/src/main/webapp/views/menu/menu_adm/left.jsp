...
<body>
	...
	<ul id="browser" class="filetree">
		...
		<li class="closed"><span class="folder">Productos</span>
			<ul>
				...
				<ul><span class="file" onMouseOver="cursor(this)" onclick="openFrame('credifam/cotizador')">Cotizador</span></ul>
				<ul><span class="file" onMouseOver="cursor(this)" onclick="openFrame('credifam/cotizaciones_pendientes')">Cotizaciones Pendientes</span></ul>
	...
	<a class="logout" href="../../../logout" target="_top">Cerrar sesión</a>		
</body>
</html>