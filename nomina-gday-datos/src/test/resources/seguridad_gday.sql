...
INSERT INTO acl_class VALUES (1, 'mx.sep.seguridad-Ngday-Ngday.modelo.ModuloMenu');
INSERT INTO acl_class VALUES (2, 'mx.sep.seguridad-Ngday-Ngday.modelo.OpcionMenu');
...
INSERT INTO t_opcion_menu VALUES (7, 'seguridad-Ngday', 'seguridad-Ngday', NULL, 11);
...
--
-- Data for Name: t_r_usuario_rol; Type: TABLE DATA; Schema: seguridad-Ngday; Owner: pruebas
--
...
--
-- Name: t_r_usuario_rol_pkey; Type: CONSTRAINT; Schema: seguridad-Ngday; Owner: pruebas; Tablespace: 
--
...
--
-- Name: fki_t_opcion_padre; Type: INDEX; Schema: seguridad-Ngday; Owner: pruebas; Tablespace: 
--
...
--
-- Name: t_r_usuario_rol_id_tr_rol_fkey; Type: FK CONSTRAINT; Schema: seguridad-Ngday; Owner: pruebas
--
...
--
-- Name: t_r_usuario_rol_id_tr_usuario_fkey; Type: FK CONSTRAINT; Schema: seguridad-Ngday; Owner: pruebas
--
